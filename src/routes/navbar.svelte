...
<div class="navbar bg-base-100">
	<div class="navbar-start">
		<div class="dropdown">
			...
			<ul
				tabindex="0"
				class="menu menu-normal dropdown-content mt-3 p-2 shadow bg-base-100 rounded-box w-52"
			>
				{#each nav as item}
					<li>
	...
	<div class="navbar-end px-4">
		<!-- {#if loggedIn}
			<button class="btn btn-circle btn-ghost normal-case px-4" on:click={handleclick}
				>Wyloguj</button
			>
		{/if} -->
		<ThemeChange />
